...
These two modules are created by copying the :ned:`TelnetClientApp` and :ned:`TelnetServerApp` modules available in INET,
and omitting the :ned:`IApp` interface. As such, the telnet traffic apps can be connected to each other directly, without
