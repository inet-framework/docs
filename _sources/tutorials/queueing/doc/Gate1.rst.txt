...
The :ned:`PacketGate` module allows packet requests (pulls/pushes) and packets to pass through it when it's open,
and blocks them when it's closed. The gate opens and closes according to the configured schedule.
The time of opening and closing is configured.
